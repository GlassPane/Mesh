...
public class ExternalResourcePackCreator implements ResourcePackProvider {
    ...
    public <T extends ResourcePackProfile> void register(Map<String, T> map, ResourcePackProfile.Factory<T> factory) {
        ...
        if(packDir.isDirectory()) {
            ...
            Optional.ofNullable(ResourcePackProfile.of(PACK_NAME, false, () -> new DirectoryResourcePack(packDir), factory, ResourcePackProfile.InsertionPosition.TOP)).ifPresent(t -> map.put(PACK_NAME, t));
        }
    }
}
