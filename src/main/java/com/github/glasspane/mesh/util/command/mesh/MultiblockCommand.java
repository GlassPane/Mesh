...
public class MultiblockCommand {
    ...
    public static LiteralArgumentBuilder<ServerCommandSource> append(LiteralArgumentBuilder<ServerCommandSource> $) {
        return $.then(CommandManager.literal("multiblock").then(CommandManager.argument("multiblock", MultiblockArgumentType.create()).then(CommandManager.argument("pos", BlockPosArgumentType.blockPos()).executes(context -> {
