 ...
 */
package dev.upcraft.mesh.annotations;
...
public class MeshAnnotationProcessor extends AbstractProcessor {
    ...
    public static final String AUTOREGISTRY_REGISTER_CLASS = "dev.upcraft.mesh.api.annotation.AutoRegistry.Register";
    public static final String AUTOREGISTRY_IGNORE_CLASS = "dev.upcraft.mesh.api.annotation.AutoRegistry.Ignore";
        ...
        for (TypeElement clazz : ElementFilter.typesIn(annotated)) {
            for (AnnotationMirror annotationMirror : clazz.getAnnotationMirrors()) {
                if (annotationMirror.getAnnotationType().equals(registerTypeMirror)) {
                    ...
                    clazz.getEnclosedElements().stream().filter(e -> {
